...
function ci_tax_create_taxonomies() {
	...
	$labels = array(
		...
		'parent_item'       => __( 'Parent Artist Categories', 'ci_theme' ),
		'parent_item_colon' => __( 'Parent Artist Categories:', 'ci_theme' ),
		'edit_item'         => __( 'Edit Artist Categories', 'ci_theme' ),
		'update_item'       => __( 'Update Artist Categories', 'ci_theme' ),
		'add_new_item'      => __( 'Add New Artist Categories', 'ci_theme' ),
		'new_item_name'     => __( 'New Artist Categories', 'ci_theme' ),
