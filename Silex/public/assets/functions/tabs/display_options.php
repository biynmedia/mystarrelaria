...
<?php
	...
	$ci_defaults['menu_position']            = 'default';
?>
<?php else: ?>

	<fieldset class="set">
		<p class="guide"><?php _e( "Control whether you want the main menu to be under the logo (default) or on the side (on the side)", 'ci_theme' ); ?></p>
		<?php
			$options = array(
				'default'    => __( 'Default', 'ci_theme' ),
				'side' => __( 'On the side', 'ci_theme' ),
			);
			ci_panel_dropdown( 'menu_position', $options, __( 'Menu position:', 'ci_theme' ) );
		?>
	</fieldset>
