...
function events_score_meta_box( $object, $box )
{
	...
	?><div class="ci-cf-wrap"><?php
		ci_metabox_open_tab( __( 'Details', 'ci_theme' ) );
			...
			ci_metabox_input( 'ci_cpt_events_address', __( 'Event Venue Address.', 'ci_theme' ) );
...
function events_save_meta( $post_id, $post ) {
	...
	update_post_meta( $post_id, 'ci_cpt_events_address', sanitize_text_field( $_POST['ci_cpt_events_address'] ) );
	...
	update_post_meta( $post_id, 'ci_cpt_events_lon', floatval( $_POST['ci_cpt_events_lon'] ) );
	update_post_meta( $post_id, 'ci_cpt_events_lat', floatval( $_POST['ci_cpt_events_lat'] ) );
